...
router.put('/:productID/shipping', authMiddleware, upload.single("shippingInvoice"), orderController.uploadShipping)

// Confirm received by buyer/seller
router.put('/:productID/receivePayment', authMiddleware, orderController.confirmPaymentReceived)
router.put('/:productID/receiveProduct', authMiddleware, orderController.confirmProductReceived)
