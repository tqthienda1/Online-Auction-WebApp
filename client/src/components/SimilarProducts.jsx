                      ...
                      <CardContent className="flex flex-col aspect-square items-center justify-center p-6">
                        ...
                        <div className="flex flex-col w-full justify-center items-center">
                          ...
                          >
                            ...
                            <Link
                              to={`/products/${p.id}`}
                              className="flex items-center justify-center text-lg font-bold w-[60%] h-12 bg-yellow-400 transition duration-200 ease-out hover:scale-105 rounded-sm uppercase mx-auto"
                            >
                              Bid Now
                            </Link>
                          </div>
