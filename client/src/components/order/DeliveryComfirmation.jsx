...
function DeliveryConfirmation({ onConfirmed, productID }) {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            await axios.put(`/orders/${productID}/receiveProduct`);
        ...
        <div className="mx-auto bg-white p-6 rounded-lg shadow-sm border border-gray-100">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                <div className="flex items-center gap-3">
                    ...
                    <label htmlFor="itemReceived" className="text-sm text-gray-800">
                ...
                <div className="flex justify-end">
                    <button
                        type="submit"
                        disabled={loading}
                        className="bg-[#FBBC04] text-white px-4 py-2 rounded-md"
                    >
